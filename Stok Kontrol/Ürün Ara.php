...
<body>
	<ul class="menu">
		...
		<li>
			<a href="Ürün Ara.php" ><img src="araw.png"></a>
		</li>
		<li>
...
<table border="1" cellspacing="20" cellpadding="20" width="30%" align="center" bgcolor="gray">
	<tr align="center">
		<td style="color: White">Ürünün Adı:    <input type="text" name="ad"></td>
		<td><input type="submit" name="submit" value="Ürünü Ara"></td></tr></table></form>
<?php
$servername = "localhost";
$username = "root";
$password = "ybs312ybs";
